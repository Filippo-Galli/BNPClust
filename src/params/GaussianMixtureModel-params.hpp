...
struct GaussianMixtureModel_params {
    /** @brief Observed data vector (one value per observation) */
    Eigen::VectorXd y;
     ...
     */
    GaussianMixtureModel_params(const Eigen::VectorXd &y, double m0, double kappa0, double alpha0, double beta0)
        : y(y), m0(m0), kappa0(kappa0), alpha0(alpha0), beta0(beta0) {}
};
