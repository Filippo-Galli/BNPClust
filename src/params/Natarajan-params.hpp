...
struct Natarajan_params {
     ...
     */
    Natarajan_params(double delta1, double alpha, double beta, double delta2, double gamma, double zeta)
        : delta1(delta1), alpha(alpha), beta(beta), delta2(delta2), gamma(gamma), zeta(zeta) {}
};
