/**
 * @file splitmerge_SAMS.cpp
 * @brief Implementation of Sequential Allocation Merge-Split (SAMS) sampler
 *
 * This file contains the complete implementation of the SplitMerge_SAMS class,
...
double
SplitMerge_SAMS::compute_acceptance_ratio_merge(double likelihood_old_clusters) {
  /**
...
void SplitMerge_SAMS::merge_move() {
  ...
  double acceptance_ratio = compute_acceptance_ratio_merge(likelihood_old_clusters);
...
double
SplitMerge_SAMS::compute_acceptance_ratio_split(double likelihood_old_cluster) {
  /**
