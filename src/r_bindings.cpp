 ...
 *
 * This file contains the R/C++ interface code that exposes the clustering
 * algorithms (DP, NGGP, and their variants) to R through Rcpp. It handles
 * object construction, method calls, and data conversion between R and C++
 * representations.
 *
...
#include "likelihoods/Gamma_likelihood_distances.hpp"
...
#include "processes/module/spatial_module_continuous.hpp"
...
// [[Rcpp::export]]
Rcpp::XPtr<GaussianMixtureModel_params>
create_GaussianMixtureModel_params(double m0, double kappa0, double alpha0,
                                   double beta0) {
  return Rcpp::XPtr<GaussianMixtureModel_params>(
      new GaussianMixtureModel_params(m0, kappa0, alpha0, beta0), true);
}
...
// [[Rcpp::export]]
Rcpp::XPtr<Gamma_likelihood_distances>
create_Gamma_likelihood_distances(SEXP data_sexp,
                                  Rcpp::XPtr<Natarajan_params> params,
                                  Rcpp::XPtr<utils_params> utils) {
  Data *data = get_data_ptr(data_sexp);
  return Rcpp::XPtr<Gamma_likelihood_distances>(
      new Gamma_likelihood_distances(*data, *params, *utils), true);
}

// [[Rcpp::export]]
Rcpp::XPtr<GaussianMixtureModel_likelihood>
create_GaussianMixtureModel_likelihood(
    SEXP data_sexp, Rcpp::XPtr<GaussianMixtureModel_params> params) {
  Data *data = get_data_ptr(data_sexp);
  return Rcpp::XPtr<GaussianMixtureModel_likelihood>(
      new GaussianMixtureModel_likelihood(*data, *params), true);
}
