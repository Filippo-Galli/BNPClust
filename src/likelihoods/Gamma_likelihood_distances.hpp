/**
 * @file Gamma_likelihood_distances.hpp
 * @brief LogLikelihood computation for clustering with cohesion a
 */
...
/**
 * @class Gamma_likelihood_distances
 ...
 * Clustering"
 */
class Gamma_likelihood_distances : public Likelihood {
private:
...
public:
   ...
   */
  Gamma_likelihood_distances(const Data &data, const Natarajan_params &params,
                             const utils_params &utils)
